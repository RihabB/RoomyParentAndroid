...
public class AppelActivity extends Activity implements WebRtcClient.RtcListener {
        ...
        public void call(Object... args) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(AppelActivity.this, "Your connected to the socket server", Toast.LENGTH_SHORT).show();
        ...
        public void call(final Object... args) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(AppelActivity.this, "Message: " + recievedString, Toast.LENGTH_SHORT).show();
